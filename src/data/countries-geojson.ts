...
export const countriesGeoJSON: CountryGeoJSON[] = [
  {
    type: 'Feature',
    properties: { name: 'United States', code: 'US' },
    geometry: {
      type: 'MultiPolygon',
      coordinates: [
        [[[-125.0, 48.0], [-125.0, 25.0], [-66.0, 25.0], [-66.0, 48.0], [-125.0, 48.0]]],
        [[[-170.0, 72.0], [-130.0, 72.0], [-130.0, 54.0], [-170.0, 54.0], [-170.0, 72.0]]],
        [[[-162.0, 23.0], [-154.0, 23.0], [-154.0, 18.0], [-162.0, 18.0], [-162.0, 23.0]]]
      ]
    }
  },
  {
    type: 'Feature',
    properties: { name: 'Canada', code: 'CA' },
    geometry: {
      type: 'Polygon',
      coordinates: [[[-141.0, 69.0], [-60.0, 69.0], [-60.0, 41.0], [-141.0, 41.0], [-141.0, 69.0]]]
    }
  },
  {
    type: 'Feature',
    properties: { name: 'Mexico', code: 'MX' },
    geometry: {
      type: 'Polygon',
      coordinates: [[[-117.0, 32.0], [-86.0, 32.0], [-86.0, 14.0], [-117.0, 14.0], [-117.0, 32.0]]]
    }
  }
];
...
export const countries: Country[] = [
  ...
  { 
    ...
    geometry: countriesGeoJSON.find(c => c.properties.code === 'CA')?.geometry
  },
  ...
  { 
    ...
    geometry: countriesGeoJSON.find(c => c.properties.code === 'MX')?.geometry
  },
  ...
  { 
    ...
    latitude: 37.09024, 
    longitude: -95.712891,
    geometry: countriesGeoJSON.find(c => c.properties.code === 'US')?.geometry
  },
